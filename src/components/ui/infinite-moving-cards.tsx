    ...
    return (
        ...
        >
            ...
            >
                {items.map((item, idx) => (
                    <li
                        className="w-[350px] max-w-full relative rounded-2xl border border-yellow-200 flex-shrink-0 bg-yellow-50/80 px-8 py-6 md:w-[450px] shadow-[0_0_15px_rgba(250,204,21,0.3)] hover:shadow-[0_0_25px_rgba(250,204,21,0.5)] transition-all duration-300"
                        key={item.name}
                    >
                        <blockquote>
                            <div
