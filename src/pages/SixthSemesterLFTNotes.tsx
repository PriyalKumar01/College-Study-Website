...
const SixthSemesterLFTNotes = () => {
  ...
  const staticSubjects = [
    ...
    { id: 'dairy', name: 'Dairy Technology', icon: '🥛', color: 'bg-blue-400', notes: [{ title: 'Dairy Technology Notes', url: '#' }] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground py-10 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-1">6th Semester LFT Notes 🌾</h1>
          <p className="opacity-70 text-sm">Leather & Food Technology · 6th Semester B.Tech</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div 
                ...
                onClick={() => {
                  if ((subject as any).isSpecial) {
                    navigate('/sixth-semester-open-electives?source=lft');
                  } else {
