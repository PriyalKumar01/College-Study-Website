...
const SixthSemesterMENotes = () => {
  ...
  const staticSubjects = [
    { id: 'hmt', name: 'Heat & Mass Transfer', icon: '🔥', color: 'bg-red-500', notes: [{ title: 'HMT Complete Notes', url: '#' }] },
    { id: 'te', name: 'Turbo Machinery', icon: '⚙️', color: 'bg-orange-500', notes: [{ title: 'Turbo Machinery Notes', url: '#' }] },
    { id: 'mae', name: 'Machine Design', icon: '🔩', color: 'bg-blue-500', notes: [{ title: 'Machine Design Notes', url: '#' }] },
    { id: 'cim', name: 'Computer Integrated Manufacturing', icon: '🏭', color: 'bg-green-500', notes: [{ title: 'CIM Notes', url: '#' }] },
    { id: 'entrepreneurship', name: 'Entrepreneurship', icon: '💡', color: 'bg-yellow-500', notes: [{ title: 'Entrepreneurship Notes', url: '#' }] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground py-10 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-1">6th Semester ME Notes 🔧</h1>
          <p className="opacity-70 text-sm">Mechanical Engineering · 6th Semester B.Tech</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
