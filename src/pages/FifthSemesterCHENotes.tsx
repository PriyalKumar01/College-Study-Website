...
const FifthSemesterCHENotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 5th Semester CHE on College Study Hub: ${shareUrl}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              {subject.fullName} - 5th Semester CHE
            </p>
          </motion.div>
          ...
          <div className="flex items-center justify-between flex-wrap gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">Official syllabus for 5th semester CHE</p>
              </div>
            </div>
            <Button 
