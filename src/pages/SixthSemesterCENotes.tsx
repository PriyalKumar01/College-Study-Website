...
const SixthSemesterCENotes = () => {
  ...
  const staticSubjects = [
    { id: 'rcd', name: 'Reinforced Concrete Design', icon: '🏗️', color: 'bg-gray-600', notes: [{ title: 'RCD Complete Notes', url: '#' }] },
    { id: 'geotech', name: 'Geotechnical Engineering', icon: '⛏️', color: 'bg-yellow-700', notes: [{ title: 'Geotechnical Engineering Notes', url: '#' }] },
    { id: 'water', name: 'Water Resources Engineering', icon: '💧', color: 'bg-blue-500', notes: [{ title: 'Water Resources Notes', url: '#' }] },
    { id: 'transport', name: 'Transportation Engineering', icon: '🛣️', color: 'bg-orange-500', notes: [{ title: 'Transportation Engineering Notes', url: '#' }] },
    { id: 'env', name: 'Environmental Engineering', icon: '🌿', color: 'bg-green-500', notes: [{ title: 'Environmental Engineering Notes', url: '#' }] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground py-10 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-1">6th Semester CE Notes 🏗️</h1>
          <p className="opacity-70 text-sm">Civil Engineering · 6th Semester B.Tech</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
