...
const ThirdSemesterOTNotes = () => {
  ...
  const { data: communityNotes } = useCommunityNotes('btech', 'OT-3rd Semester');
  const { user } = useAuth();
  ...
  // Subject names MUST match courseStructure.ts 'OT-3rd Semester' keys exactly
  const staticSubjects = [
    {
      id: 'oil-chemistry',
      name: 'Oil Chemistry',
      fullName: 'Oil Chemistry',
      description: 'Fundamentals of oil and fat chemistry',
      notes: [
    ...
    },
    {
      id: 'oil-processing',
      name: 'Oil Processing',
      fullName: 'Oil Processing Technology',
      description: 'Industrial oil processing techniques',
      notes: []
    },
    {
      id: 'surface-coatings',
      name: 'Surface Coatings',
      fullName: 'Surface Coatings',
      description: 'Paints, varnishes and surface protection',
      notes: []
    },
    {
      id: 'math2',
    ...
    },
    {
      ...
      description: 'OT 3rd Semester PYQs',
      notes: []
    },
    {
      id: 'assignments',
      ...
      description: 'OT 3rd Semester Assignments',
      notes: []
    }
  ];
