      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Mechanical Engineering — 5th Semester</p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground text-sm">5th Sem ME Syllabus</p>
              <p className="text-xs text-muted-foreground">Official syllabus for 5th Semester B.Tech ME</p>
            </div>
          </div>
          <button
        ...
        <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            ...
            >
              <div 
                className="group border-2 border-yellow-500/50 bg-gradient-to-br from-yellow-50/50 to-amber-50/50 dark:from-yellow-950/10 dark:to-amber-950/10 hover:border-yellow-500 rounded-xl p-5 transition-all duration-300 hover:shadow-lg h-full flex flex-col relative cursor-pointer"
