...
const FifthSemesterMENotes = () => {
  ...
  const subjectPlaylists: Record<string, { detailed: { title: string; url: string; recommended?: boolean }[]; oneshot: { title: string; url: string; recommended?: boolean }[] }> = {
    ht: {
      detailed: [
        { title: 'Heat Transfer Complete', url: '#', recommended: true },
      ],
      oneshot: []
    },
    md: {
      detailed: [
        { title: 'Machine Design Complete', url: '#', recommended: true },
      ],
      oneshot: []
    }
  };
  ...
  const subjects = [
    {
      ...
      color: 'bg-orange-500',
      notes: [
        { title: 'Heat Transfer Complete Notes', url: '#' },
      ]
    },
    {
      id: 'md',
