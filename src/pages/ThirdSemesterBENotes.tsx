...
const ThirdSemesterBENotes = () => {
  ...
  const { data: communityNotes } = useCommunityNotes('btech', 'BE-3rd Semester');
  const { user } = useAuth();
  ...
  const staticSubjects = [
    {
      id: 'human-anatomy',
      name: 'Human Anatomy',
      fullName: 'Human Anatomy & Physiology',
    ...
    },
    {
      id: 'biomaterials',
      name: 'Biomaterials',
      fullName: 'Biomaterials',
      description: 'Materials used in biomedical applications',
      notes: []
    },
    {
      id: 'biomedical-instrumentation',
      name: 'Biomedical Instrumentation',
      fullName: 'Biomedical Instrumentation',
      description: 'Medical devices and measurement systems',
      notes: []
    },
    {
      id: 'math2',
    ...
    },
    {
      ...
      description: 'BE 3rd Semester PYQs',
      notes: []
    },
    {
      id: 'assignments',
      ...
      description: 'BE 3rd Semester Assignments',
      notes: []
    }
  ];
