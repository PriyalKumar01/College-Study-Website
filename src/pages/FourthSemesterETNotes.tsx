  ...
  const subjects = [
    {
      id: 'et-subject-1',
      name: 'Subject 1',
      fullName: 'Electronics & Telecom Subject 1',
      icon: '📡',
      color: 'bg-blue-500',
      playlists: {
    ...
    },
    {
      id: 'et-subject-2',
      name: 'Subject 2',
      fullName: 'Electronics & Telecom Subject 2',
      icon: '📶',
      color: 'bg-green-500',
      playlists: {
        detailed: [{ title: 'Playlist Coming Soon', url: '#' }],
    ...
    },
    {
      id: 'et-subject-3',
      name: 'Subject 3',
      fullName: 'Electronics & Telecom Subject 3',
      icon: '⚡',
      color: 'bg-yellow-500',
      playlists: {
        detailed: [{ title: 'Playlist Coming Soon', url: '#' }],
    ...
    },
    {
      id: 'et-subject-4',
      name: 'Subject 4',
      fullName: 'Electronics & Telecom Subject 4',
      icon: '🔌',
      color: 'bg-purple-500',
      playlists: {
        detailed: [{ title: 'Playlist Coming Soon', url: '#' }],
