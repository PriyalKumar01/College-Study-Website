...
const SixthSemesterPTNotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string, subjectId: string) => {
    ...
    const message = `Check out ${subjectName} notes for 6th Semester PT on College Study Hub: ${shareUrl}`;
      ...
      <div className="min-h-screen bg-gradient-hero"><Navbar />
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">6th Semester PT</p>
          </motion.div>
    ...
    <div className="min-h-screen bg-gradient-hero"><Navbar />
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">6th Semester PT Notes 🧶</h1>
          <p className="text-muted-foreground text-lg"><strong>Polymer Technology</strong> — 6th Semester</p>
        </motion.div>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
