  ...
  const semesters = [
    {
      ...
      description: 'Quantum Mechanics, Mathematical Methods, Electrodynamics, and Numerical Methods.',
      href: '/bsms/sem-5'
    },
    {
      sem: '6th Semester',
      ...
      description: 'Condensed Matter Physics, Nuclear Physics, Optics & Photonics, and Electives.',
      href: '/bsms/sem-6'
    }
  ];
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">BS-MS 3rd Year 📚</h1>
