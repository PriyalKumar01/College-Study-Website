...
const ThirdSemesterFTNotes = () => {
  ...
  // Playlist data for FT subjects (mostly empty, except Math-II and EM)
  const subjectPlaylists = {
    'food-chemistry': { detailed: [], oneshot: [] },
    'food-microbiology': { detailed: [], oneshot: [] },
    'food-processing': { detailed: [], oneshot: [] },
    math2: {
      detailed: [
  ...
  const staticSubjects = [
  {
    ...
    {
      id: 'mbf',
      name: 'Microbiology & BioChemistry of Food (REFER from 3rd Sem BIOTECH BRANCH)',
      icon: '🧪',
      color: 'bg-emerald-500',
      notes: [
            { title: 'Microbiology -REFER from 3rd Sem BIOTECH BRANCH (if topics Match)', url: 'https://college-study.netlify.app/third-semester-bt' },
            { title: 'BioChemistry -REFER from 3rd Sem BIOTECH BRANCH (if topics Match)', url: 'https://college-study.netlify.app/third-semester-bt' },

      ]
    },
    {
      id: 'fofs',
      name: 'Fundamentals of Food Science & Human Nutrition',
      icon: '⚙️',
      color: 'bg-blue-500',
      notes: [
        { title: 'You May refer this PDF (as per your Syllabus)', url: 'https://web.sol.du.ac.in/my_modules/type/cbcs-40/data/root/B.A.%20Programme/Semester%201/DISCIPLINE%20SPECIFIC%20CORE%20COURSE-DSC/NHE%20-%20Fundamentals%20of%20Nutrition%20and%20Food%20Science/English%20Medium/Unit%201-3.pdf' },
      ]
    },
    {
      id: 'falab',
      name: 'Food Analysis Lab',
      icon: '👞',
      color: 'bg-amber-500',
      notes: [
                { title: 'You May refer this PDF (as per your Syllabus)', url: 'https://buat.edu.in/wp-content/uploads/2025/06/Manual.pdf' },
...
interface Note {
  ...
  const syllabus = {
    ...
    url: 'https://drive.google.com/file/d/1yZPR9AKiTRpvAaRDqNjMj-pkbS7JxYIS/view?usp=drivesdk'
  };
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Food Technology — 3rd Semester</p>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase opacity-50 mb-3">Food Technology Notes</p>
          <h1 className="text-4xl md:text-5xl font-serif leading-tight mb-3">
            3rd Semester<br />
            <span className="opacity-60">Food Technology Notes</span>
          </h1>
          <p className="text-sm opacity-50 mb-8">B.Tech. Food Technology — Comprehensive study materials and resources</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <h3 className="text-base font-bold text-foreground mb-3">📚 FT 3rd Semester — Important Instructions</h3>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p><strong className="text-foreground">✨ Hi Food Tech Juniors!</strong> A few tips for your 3rd semester — read carefully.</p>
            <p>• <strong className="text-foreground">Food Chemistry & Microbiology:</strong> Focus on food constituents, metabolic reactions, spoilage mechanisms, and preservation systems. This forms the basis of all food science.</p>
            <p>• <strong className="text-foreground">Food Processing Technology:</strong> Study heating, drying, preservation, and canning operations. Make sure you understand the engineering behind these unit operations.</p>
            <p>• <strong className="text-foreground">Maintain CGPA:</strong> Keep a solid score of <strong className="text-foreground">7.5+ CGPA</strong> to clear eligibility filters for corporate FMCG recruitments.</p>
            <p className="text-red-600 dark:text-red-400"><strong>⚠️ Important:</strong> Exam papers should be well-structured. Write precise chemical pathways and draw neat diagrams of processing machinery for maximum score.</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Official syllabus for 3rd semester B.Tech FT</p>
            </div>
          </div>
          <button
