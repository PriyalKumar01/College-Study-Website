...
const FourthSemesterFTNotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 4th Semester FT on College Study Hub: ${shareUrl}`;
  ...
  const staticSubjects = [
    ...
    },
    {
      ...
      color: 'bg-green-500',
      notes: [
        { title: 'Food Chemistry Notes', url: '#' }
      ]
    },
    {
      id: 'food-preservation',
      name: 'Food Preservation & Processing',
      icon: '🥫',
      color: 'bg-orange-500',
      notes: [
        { title: 'Food Preservation Notes', url: '#' }
      ]
    },
    {
    ...
    },
    {
      ...
      color: 'bg-red-600',
      notes: [
        { title: 'All 4th Sem FT PYQs (2023-24)', url: '#' }
      ]
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              All notes for {subject.name} - 4th Semester B.Tech FT
            </p>
          </motion.div>
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div
          ...
          className="mb-8"
        >
          <Button onClick={() => navigate('/btech-notes/second-year/semester-4')} variant="outline" className="mb-4">
            <ArrowLeft className="h-4 w-4 mr-2" />
            Back to 4th Semester
          </Button>
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">
            4th Sem B.Tech FT Notes 📖
          </h1>
        </motion.div>
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <div className="space-y-2 text-sm text-green-700 dark:text-green-300">
                ...
                <p>• <strong>Engg. Math's:</strong> Follow the Fearless and MKS playlists — many PYQs match from them.</p>
                <p>• <strong>Food Chemistry:</strong> Focus on unit-wise notes and practice numerical problems. NCERT chemistry background helps.</p>
                <p>• <strong>Food Preservation:</strong> Understand the methods and mechanisms thoroughly — theory + diagrams are important.</p>
        ...
        >
          <Card className="gradient-card border-2 border-primary/20 shadow-lg">
            <CardHeader>
              ...
              <CardDescription>Official syllabus for 4th Semester B.Tech FT</CardDescription>
            </CardHeader>
            <CardContent>
              <Button
