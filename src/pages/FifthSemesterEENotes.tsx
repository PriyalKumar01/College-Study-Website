  ...
  const subjects = [
    {
      ...
      color: 'bg-yellow-500',
      playlists: {
        detailed: [{ title: 'Power Systems Complete', url: '#', recommended: true }],
        oneshot: []
      },
      notes: [{ title: 'PS Complete Notes', url: '#' }]
    },
    {
      id: 'control',
      ...
      color: 'bg-blue-500',
      playlists: {
        detailed: [{ title: 'Control Systems Complete', url: '#', recommended: true }],
        oneshot: []
      },
      ...
      <div className="min-h-screen bg-gradient-hero">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">5th Semester EE</p>
          </motion.div>
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">5th Semester EE Notes</h1>
