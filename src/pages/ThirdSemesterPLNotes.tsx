...
const ThirdSemesterPLNotes = () => {
  ...
  // Playlist data for PL subjects (mostly empty, except Math-II)
  const subjectPlaylists = {
    itpc : { detailed: [], oneshot: [] },
    pclab : { detailed: [], oneshot: [] },
    pm : { detailed: [], oneshot: [] },
  ...
  const staticSubjects = [
    ...
    {
      id: 'itpc',
      name: 'Intro to Polymer Chemistry (ITPC)',
      icon: '🛞',
      color: 'bg-teal-500',
      notes: []
    },
    {
      id: 'pm',
      name: 'Polymerization Engineering-I',
      icon: '📐',
      color: 'bg-indigo-500',
      notes: []
    },
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Plastic Technology — 3rd Semester</p>
          </div>
        </div>
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <div className="flex flex-wrap gap-2">
            <span className="text-xs font-semibold tracking-wider uppercase border border-background/30 px-3 py-1.5 rounded">PL Department</span>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <h3 className="text-base font-bold text-foreground mb-3">📚 PL 3rd Semester — Important Instructions</h3>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p><strong className="text-foreground">✨ Hi Plastics Juniors!</strong> A few pointers for your 3rd semester — read carefully.</p>
            <p>• <strong className="text-foreground">Polymer Science:</strong> Spend time understanding polymer structures, molecular weights, and polymerization kinetics. This is fundamental to all subsequent plastic technology courses.</p>
            <p>• <strong className="text-foreground">Plastic Processing:</strong> Study extrusion, injection molding, and thermoforming cycles. Practical lab understanding is highly valued by companies.</p>
            <p>• <strong className="text-foreground">Maintain CGPA:</strong> Aim for <strong className="text-foreground">7.5+ CGPA</strong> minimum to meet target cutoff requirements for core industry recruitments.</p>
            <p className="text-red-600 dark:text-red-400"><strong>⚠️ Important:</strong> Exam presentations should be systematic. Draw clear, labeled diagrams of industrial processing machinery and explain polymer reactions step-by-step.</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Official syllabus for 3rd semester B.Tech PL</p>
            </div>
          </div>
          <button
