...
const FifthSemesterBTNotes = () => {
  ...
  const { data: communityNotes, refetch: refreshNotes } = useCommunityNotes('btech', 'BT-5th Semester');
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Biotechnology — 5th Semester</p>
          </div>
        </div>
