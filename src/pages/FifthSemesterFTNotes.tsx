      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Food Technology — 5th Semester</p>
          </div>
        </div>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="font-semibold text-foreground text-sm">5th Sem FT Syllabus</p>
              <p className="text-xs text-muted-foreground">Official syllabus for 5th Semester B.Tech FT</p>
            </div>
          </div>
          <button
