...
const FifthSemesterFTNotes = () => {
  ...
  const subjectPlaylists: Record<string, { detailed: any[]; oneshot: any[] }> = {
    ...
    'food-engineering': { detailed: [], oneshot: [] },
    'food-processing': { detailed: [], oneshot: [] },
    'food-quality': { detailed: [], oneshot: [] }
  };
  ...
  const staticSubjects = [
    ...
    },
    {
      ...
      icon: '🦠',
      color: 'bg-green-500',
      notes: [{ title: 'Food Microbiology Notes', url: '#' }]
    },
    {
      id: 'food-engineering',
      ...
      icon: '⚙️',
      color: 'bg-blue-500',
      notes: [{ title: 'Food Engineering Notes', url: '#' }]
    },
    {
      id: 'food-processing',
      name: 'Food Processing Technology-II',
      icon: '🏭',
      color: 'bg-orange-500',
      notes: [{ title: 'Food Processing Tech-II Notes', url: '#' }]
    },
    {
      id: 'food-quality',
      name: 'Food Quality Control & Safety',
      icon: '✅',
      color: 'bg-teal-500',
      notes: [{ title: 'Food Quality Control Notes', url: '#' }]
    },
    {
      id: 'assignments',
    ...
    },
    {
      ...
      icon: '❓',
      color: 'bg-red-500',
      notes: [{ title: 'All 5th Sem FT PYQs', url: '#' }]
    }
  ];
  ...
  const syllabus = { title: '5th Sem FT Syllabus', url: '#' };
      ...
      <div className="min-h-screen bg-gradient-hero">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-8">
            ...
            <p className="text-muted-foreground text-lg">All notes for {subject.name} - 5th Semester FT B.Tech</p>
          </motion.div>
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="mb-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-foreground mb-2">5th Sem B.Tech FT Notes 📖</h1>
        </motion.div>

        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1, duration: 0.5 }}
          className="mb-8 p-6 bg-gradient-to-r from-green-50 to-teal-50 dark:from-green-900/20 dark:to-teal-900/20 rounded-lg border-2 border-green-200 dark:border-green-800">
          <div className="flex items-start gap-3">
            <div className="flex-shrink-0 w-8 h-8 bg-green-500 rounded-full flex items-center justify-center">
              <span className="text-white text-sm font-bold">!</span>
            </div>
            <div>
              <h3 className="text-lg font-semibold text-green-800 dark:text-green-200 mb-2">📚 Important Branch Information</h3>
              <div className="space-y-2 text-sm text-green-700 dark:text-green-300">
                <p><strong>✨ Only for FT students:</strong> These notes are specifically designed for Food Technology students.</p>
                <p>• <strong>Food Microbiology:</strong> Focus on microbial growth, food spoilage, and food safety standards.</p>
                <p>• <strong>Food Engineering:</strong> Understand heat & mass transfer, fluid flow, and equipment design in food processing.</p>
                <p>• <strong>Food Quality Control:</strong> Learn about HACCP, GMP, and food safety regulations. Very important for industry applications.</p>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2, duration: 0.5 }} className="mb-8">
          <Card className="gradient-card border-2 border-primary/20 shadow-lg">
            <CardHeader>
              <CardTitle className="flex items-center gap-2"><FileText className="h-5 w-5" />5th Sem FT Syllabus</CardTitle>
              <CardDescription>Official syllabus for 5th Semester B.Tech FT</CardDescription>
            </CardHeader>
            <CardContent>
