...
const FifthSemesterCENotes = () => {
  ...
  const subjectPlaylists: Record<string, { detailed: { title: string; url: string; recommended?: boolean }[]; oneshot: { title: string; url: string; recommended?: boolean }[] }> = {
    rcc: {
      detailed: [
        { title: 'RCC Complete', url: '#', recommended: true },
      ],
      oneshot: []
    },
    geotech: {
      detailed: [
        { title: 'Geotechnical Engineering Complete', url: '#', recommended: true },
      ],
      oneshot: []
    }
  };
  ...
  const subjects = [
    ...
    },
    {
      ...
      color: 'bg-amber-600',
      notes: [
        { title: 'Geotech Complete Notes', url: '#' },
      ]
    },
    {
      id: 'openElective',
