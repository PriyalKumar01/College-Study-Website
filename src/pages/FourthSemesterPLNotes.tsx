...
const FourthSemesterPLNotes = () => {
  ...
  const staticSubjects = [
    {
      id: 'hto',
      name: 'Heat Transfer Operations (HTO)',
      icon: '💻',
      color: 'bg-blue-500',
      notes: [
        { title: 'HTO Unit 1 Notes', url: 'https://drive.google.com/file/d/1mw-W5Feapn5FOGTJqL_BsUXT5-YXyx8D/view?usp=drivesdk' },
        { title: 'HTO Radiation Notes', url: 'https://drive.google.com/file/d/16QiPSJKpy4g0NEMn3w9_ct2CNP_U9b8F/view?usp=drivesdk' },
        { title: 'HTO Boiling,Condensation,Evaporation Notes', url: 'https://drive.google.com/file/d/1crFm8mUX0x5JK7-QSTCB8pFt9yiM4dJ-/view?usp=drivesdk' },
        { title: 'HTO Convection Notes', url: 'https://drive.google.com/file/d/1TUn0f5IbpNArApLyGeqJNUl_4lWVXZ92/view?usp=drivesdk' },
      ]
    },
    {
      id: 'cet',
    ...
    {
      id: 'mat',
      name: 'Modern Analytical Techniques (MAT)',
      icon: '🔌',
      color: 'bg-teal-500',
      notes: []
    },
    ...
    {
      id: 'pe2',
      name: 'Polymerization engineering-II',
      icon: '🌐',
      color: 'bg-purple-500',
      notes: []
    },
  ...
  const { data: communityNotes, refetch: refreshNotes } = useCommunityNotes('btech', 'PL-4th Semester');
  ...
  const syllabus = {
    ...
    url: 'https://drive.google.com/file/d/1PUot9TyqITqB2FKt2ej6lb-NLMPEx2tE/view?usp=drivesdk'
  };
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Plastics Engineering — 4th Semester</p>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase opacity-50 mb-3">Plastics Engineering Notes</p>
          <h1 className="text-4xl md:text-5xl font-serif leading-tight mb-3">
            4th Semester<br />
            <span className="opacity-60">Plastics Engineering Notes</span>
          </h1>
          <p className="text-sm opacity-50 mb-8">B.Tech. Plastics Engineering — Comprehensive study materials and resources</p>
          <div className="flex flex-wrap gap-2">
            <span className="text-xs font-semibold tracking-wider uppercase border border-background/30 px-3 py-1.5 rounded">Plastics Department</span>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <h3 className="text-base font-bold text-foreground mb-3">📚 Plastics 4th Semester — Important Instructions</h3>
          <div className="space-y-2 text-sm text-muted-foreground">
            <p><strong className="text-foreground">✨ Hi Plastics Juniors!</strong> Important things to keep in mind for 4th semester Plastic Technology:</p>
            <p>• <strong className="text-foreground">Core Focus:</strong> Processing of Polymers -I (PP-I), Polymerization Engineering-II & HTO are core subjects. Master polymer processing concepts early.</p>
            <p>• <strong className="text-foreground">Maintain CGPA:</strong> Aim for <strong className="text-foreground">7.5+ CGPA</strong> for safe eligibility during campus placements.</p>
            <p>• <strong className="text-foreground">Numerical Preparation:</strong> Practice CONM & CET numerical problems regularly.</p>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Official syllabus for 4th semester B.Tech PL</p>
            </div>
          </div>
          <button
