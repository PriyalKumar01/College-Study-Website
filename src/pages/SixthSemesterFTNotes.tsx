...
const SixthSemesterFTNotes = () => {
  ...
  const staticSubjects = [
    { id: 'footwear', name: 'Footwear Technology', icon: '👟', color: 'bg-amber-700', notes: [{ title: 'Footwear Technology Notes', url: '#' }] },
    { id: 'leather', name: 'Leather Processing', icon: '🧤', color: 'bg-amber-800', notes: [{ title: 'Leather Processing Notes', url: '#' }] },
    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground py-10 px-4">
        <div className="max-w-7xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-1">6th Semester FT Notes 👟</h1>
          <p className="opacity-70 text-sm">Footwear Technology · 6th Semester B.Tech</p>
        </div>
      </div>
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
              ...
              <div 
                ...
                onClick={() => {
                  if ((subject as any).isSpecial) {
                    navigate('/sixth-semester-open-electives?source=ft');
                  } else {
