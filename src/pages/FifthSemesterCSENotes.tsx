...
const FifthSemesterCSENotes = () => {
  ...
  const staticSubjects = [
    ...
    },
    {
      ...
      notes: [
        ...
        { title: 'DS Complete Notes & Q&A', url: 'https://youngresearcher.in/ds_qa/', recommended: true },
        ...
        { title: 'DS Practical File- Priyal(CSE)', url: 'https://drive.google.com/file/d/19RsKe9Aw3FT1_m35r9kOhqSKsA5tF1jg/view?usp=drivesdk', recommended: true },
        { title: 'DS -Practical Exam PYQs(2025-26)', url: 'https://drive.google.com/file/d/1V7Un3Ye1MEQvx_LEY-3QHvYKJyUEUfuZ/view?usp=drivesdk', recommended: true },
      ]
    },
    {
      id: 'cn',
  ...
  const { data: communityNotes, refetch: refreshNotes } = useCommunityNotes('btech', ['CSE-5th Semester', 'IT-5th Semester', 'CSE-AIML-5th Semester']);
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase opacity-50 mb-3">5th Semester — B.Tech Notes</p>
          ...
          <p className="text-sm opacity-60 mb-8 max-w-xl">Comprehensive study materials, notes, playlists, and PYQs for CSE, IT and CSE (AI & ML) 5th Semester.</p>
...
// Verified against 5th sem CSE syllabus
