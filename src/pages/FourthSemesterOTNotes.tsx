...
const FourthSemesterOTNotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 4th Semester OT on College Study Hub: ${shareUrl}`;
  ...
  const staticSubjects = [
    {
      ...
      color: 'bg-blue-500',
      playlists: {
        detailed: [{ title: 'M3 Complete Playlist', url: '#', recommended: true }],
        oneshot: [{ title: 'M3 One Shot', url: '#' }]
      },
      notes: [{ title: 'M3 Unit-1 Notes', url: '#' }, { title: 'M3 Unit-2 Notes', url: '#' }]
    },
    {
      id: 'oil',
      ...
      notes: [{ title: 'Oil Processing Notes', url: '#' }]
    },
    {
      id: 'refining',
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">4th Semester OT Notes</h1>
          <p className="text-lg text-muted-foreground">Oil Technology study materials</p>
        </motion.div>
