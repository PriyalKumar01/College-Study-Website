...
const FourthSemesterOTNotes = () => {
  ...
  const staticSubjects = [
    ...
    {
      id: 'conm',
      name: 'Computer Oriented Numericals Method',
      icon: '🐍',
      color: 'bg-orange-500',
      notes: []
    },
    {
      id: 'etobm',
      name: 'Expression & Extraction Technique of Oil Bearing Materials',
      icon: '🔌',
      color: 'bg-teal-500',
      notes: []
    },
    {
      id: 'eoc',
      name: 'Essential Oil and Cosmetics',
      icon: '🔌',
      color: 'bg-teal-500',
      notes: []
    },
  ...
  const { data: communityNotes, refetch: refreshNotes } = useCommunityNotes('btech', 'OT-4th Semester');
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-10 px-4 sm:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <p className="text-xs opacity-50 uppercase tracking-widest">Oil Tech Engineering — 4th Semester</p>
          </div>
        </div>
    ...
    <div className="min-h-screen bg-background flex flex-col">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase opacity-50 mb-3">Oil Tech Engineering Notes</p>
          <h1 className="text-4xl md:text-5xl font-serif leading-tight mb-3">
            4th Semester<br />
            <span className="opacity-60">Oil Tech Engineering Notes</span>
          </h1>
          <p className="text-sm opacity-50 mb-8">B.Tech. Oil Tech Engineering — Comprehensive study materials and resources</p>
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 space-y-10 flex-1 w-full mb-12">
        ...
        >
          <h3 className="text-base font-bold text-foreground mb-3">📚 Oil Tech 4th Semester — Important Instructions</h3>
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Official syllabus for 4th semester B.Tech OT</p>
            </div>
          </div>
          <button
...
export default FourthSemesterOTNotes;