...
const FourthSemesterCENotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 4th Semester CE on College Study Hub: ${shareUrl}`;
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">4th Semester CE Notes</h1>
