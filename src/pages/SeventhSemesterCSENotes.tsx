...
const SeventhSemesterCSENotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 7th Semester CSE/IT on College Study Hub: ${shareUrl}`;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
          ...
          >
            ...
            <p className="text-muted-foreground text-lg">
              All notes for {subject.name} - 7th Semester B.Tech
            </p>
          </motion.div>
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="w-full">
              <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-200 mb-3">📚 CSE/IT 7th Semester — Important Instructions</h3>
              <div className="space-y-2 text-sm text-blue-700 dark:text-blue-300">

                <p><strong>✨ Hi CSE/IT Juniors!</strong> A few important things to keep in mind as you progress through 7th semester — read carefully, this will genuinely help you.</p>
        ...
        >
          <Card className="gradient-card">
            <CardHeader>
              ...
              <CardDescription>
                Official syllabus for 7th semester B.Tech
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Button
