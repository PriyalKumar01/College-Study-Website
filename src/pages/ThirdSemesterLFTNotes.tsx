...
const ThirdSemesterLFTNotes = () => {
  ...
  const handleWhatsAppShare = (subjectName: string) => {
    ...
    const message = `Check out ${subjectName} notes for 3rd Semester Leather & Fashion on College Study Hub: ${shareUrl}`;
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="w-full">
              <h3 className="text-lg font-semibold text-blue-800 dark:text-blue-200 mb-3">📚 Leather & Fashion 3rd Semester — Important Instructions</h3>
