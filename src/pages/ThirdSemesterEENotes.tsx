        ...
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle className="flex items-center gap-2 text-lg">
              <Sparkles className="h-5 w-5 text-primary" /> Add Subject to 3rd Sem EE
            </DialogTitle>
            <DialogDescription>
          ...
          <div className="space-y-4 py-2">
            <div>
              ...
              <Input
                placeholder="e.g. Basic System Analysis or BSA"
                value={newSubName}
            ...
            <div>
              ...
              <Input
                placeholder="e.g. Basic System Analysis (BSA)"
