...
const FifthSemesterPLNotes = () => {
  ...
  const { data: communityNotes, refetch: refreshNotes } = useCommunityNotes('btech', 'PL-5th Semester');
  ...
  const staticSubjects = [
    {
      id: 'pp2',
      name: 'Processing of Polymers -II',
      icon: '⚙️',
      color: 'bg-blue-500',
    ...
    {
      id: 'pmdd',
      name: 'Plastic Mould Design and Dies',
      icon: '📐',
      color: 'bg-purple-500',
      playlists: { detailed: [], oneshot: [] },
      notes: []
    ...
    {
      id: 'prt',
      name: 'Polymer Rheology and Testing',
      icon: '🧪',
      color: 'bg-indigo-500',
      playlists: { detailed: [], oneshot: [] },
      notes: []
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-8 py-10 flex-1 w-full mb-12">
          {subject.notes.length === 0 ? (
            <div className="text-center py-16 border border-dashed rounded-xl bg-card">
              ...
              <p className="text-xs text-muted-foreground">Contributions from students and admins are welcome!</p>
            </div>
          ) : (
