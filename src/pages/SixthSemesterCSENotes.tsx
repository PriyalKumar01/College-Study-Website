    ...
    <div className="min-h-screen bg-background">
      ...
      <div className="bg-foreground dark:bg-card text-background dark:text-foreground pt-16 pb-12 px-4 sm:px-8">
        <div className="max-w-5xl mx-auto">
          ...
          <p className="text-xs font-bold tracking-[0.2em] uppercase opacity-50 mb-3">6th Semester — B.Tech Notes</p>
          ...
          <p className="text-sm opacity-60 mb-8 max-w-xl">Comprehensive study materials, notes, playlists, and PYQs for CSE, IT and CSE (AI & ML) 6th Semester.</p>
...
// Verified against 6th sem CSE syllabus
