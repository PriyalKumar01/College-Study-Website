...
const FifthSemesterBENotes = () => {
  ...
  const { data: communityNotes } = useCommunityNotes('btech', 'BE-5th Semester');
  const { user } = useAuth();
  ...
  // courseStructure: Medical Imaging, Biomechanics, Hospital Engineering, Rehabilitation Engineering
    ...
    <div className="min-h-screen bg-gradient-hero">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <motion.div initial={{ opacity: 0, y: -20 }} animate={{ opacity: 1, y: 0 }} className="text-center mb-12">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-foreground">5th Semester BE Notes</h1>
          <p className="text-lg text-muted-foreground">Biomedical Engineering study materials</p>
        </motion.div>
