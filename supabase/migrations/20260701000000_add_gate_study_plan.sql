...
-- Add updated constraint check including 'gate_study' plan
ALTER TABLE public.premium_purchases ADD CONSTRAINT premium_purchases_plan_check 
  CHECK (plan IN ('companies', 'hr_emails', 'resume', 'roadmaps', 'gate_study'));

-- Update record_free_purchase function to handle 'gate_study' plan
